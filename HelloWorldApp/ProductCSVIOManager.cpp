...
//
// ProductCSVIOManager class implementation to store data in text file

// Save products to a file
void ProductCSVIOManager::saveProducts(const std::vector<Product>& products) {
...
std::vector<Product> ProductCSVIOManager::loadProducts() {
...
void ProductCSVIOManager::displayProducts(const std::vector<Product>& products) {
...
void ProductCSVIOManager::addProduct(std::vector<Product>& products, const Product& product) {
	products.push_back(product);
	std::cout << "Product added: " << product.getTitle() << std::endl;
}
void ProductCSVIOManager::removeProduct(std::vector<Product>& products, int productId) {
...
void ProductCSVIOManager::updateProduct(std::vector<Product>& products, const Product& updatedProduct) {
